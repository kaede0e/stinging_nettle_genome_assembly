...
#colours
pal=pnw_palette(name="Sunset2",n=100,type="continuous")
...
# If you want to modify y-axis order as you wish,
  desired_order <- c("F_H2_chr_01", "M_H2_chr_01", "M_H1_chr_01", "F_H1_chr_01", "F_H2_chr_02", "M_H2_chr_02", "M_H1_chr_02", "F_H1_chr_02", "F_H2_chr_03", "M_H2_chr_03", "M_H1_chr_03", "F_H1_chr_03", "F_H2_chr_04", "M_H2_chr_04", "M_H1_chr_04", "F_H1_chr_04", "F_H2_chr_05", "M_H2_chr_05", "M_H1_chr_05", "F_H1_chr_05", "F_H2_chr_06", "M_H2_chr_06", "M_H1_chr_06", "F_H1_chr_06", "F_H2_chr_07", "M_H2_chr_07", "M_H1_chr_07", "F_H1_chr_07", "F_H2_chr_08", "M_H2_chr_08", "M_H1_chr_08", "F_H1_chr_08", "F_H2_chr_09", "M_H2_chr_09", "M_H1_chr_09", "F_H1_chr_09", "F_H2_chr_10", "M_H2_chr_10", "M_H1_chr_10", "F_H1_chr_10", "F_H2_chr_11", "M_H2_chr_11", "M_H1_chr_11", "F_H1_chr_11", "F_H2_chr_12", "M_H2_chr_12", "M_H1_chr_12", "F_H1_chr_12", "F_H2_chr_13", "M_H2_chr_13", "M_H1_chr_13", "F_H1_chr_13")
  ...
  geom_segment(show.legend=FALSE, size=3) +
                      geom_point(alpha=0.2, size=1) + theme_bw() +
  ...
  xlab('reference sequence') + ylab('assembly')  +  scale_colour_gradient2(low = pal[1], high = pal[100], midpoint = 97.5)
...
pdf( paste(name, ".pdf", sep ="_"),  width=60, height=60)
print(P1)
dev.off()
